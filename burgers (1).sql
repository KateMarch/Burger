...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 19 2022 г., 11:09
...
(7, 'Мясной', 250, 'Невероятно большой и аппетитный! В нем много сыра, сочных овощей и соуса, тающая во рту булочка и они – нежные и ароматные стрипсы из отборного куриного филе', 'http://localhost/img/burger/1.png'),
(8, 'Хлебный', 250, 'Очень вкусный', 'http://localhost/img/burger/1.png');
